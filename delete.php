    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link" href="logout.php" id="logout">Log out</a>
          ...
          <li class="nav-item">
        <a class="nav-link" href="admin.php" id="signup">Admin</a>
      </li>
  </div>
</nav>
    ...
    <main>
        <div class="d-flex justify-content-center ">
          <form action="" method="post" class="w-50" >
            <div class="pt-2">
              <?php inputElement("<i class='fas fa-id-badge'></i>","ID","Event_id",setID());?>
            </div>
            <div class="pt-2">
              <?php inputElement("<i class='fas fa-book'></i>","Name","name","");?>
            </div>
            <div class="pt-2">
              <?php inputElement("<i class='fas fa-image'></i>","Date","event_date","");?>
            </div>
            <div class="pt-2">
              <?php inputElement("<i class='fas fa-code'></i>","Time","event_time","");?>
            </div>
            <div class="pt-2">
            ...
            <div class="row pt-2">
              <div class="col">
                <?php inputElement("<i class='fas fa-user-secret'></i>","Image","imgage","");?>
              </div>
              <div class="col">
                <?php inputElement("<i class='fas fa-users'></i>","Capacity","capacity","");?>
              </div>
            </div>

            <div class="pt-2">
              <?php inputElement("<i class='fas fa-align-justify'></i>","URL","url","");?>
            </div>

            <div class="row">
              <div class="col">
                <?php inputElement("<i class='fa fa-gg'></i>","Email","email","");?>
              </div>
              <div class="col">
                <?php inputElement("<i class='fab fa-old-republic'></i>","Phone","phone","");?>
              </div>
            </div>

              <div class="row">
              <div class="col">
                <?php inputElement("<i class='far fa-calendar-alt'></i>","Address","address","");?>
              </div>
              <div class="col">
                <?php inputElement("<i class='fab fa-old-republic'></i>","City","city","");?>
              </div>
              <div class="col">
                <?php inputElement("<i class='fab fa-old-republic'></i>","Postal","postal_code","");?>
              </div>
              <div class="col">
